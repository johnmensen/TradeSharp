...
namespace TradeSharp.Client.BL
{
	public class RichTextBoxEx : RichTextBox
	{
	    ...
	    private string correctRtfHeader;
		...
		public RichTextBoxEx()
		{
		    ...
		    this.Rtf = "";
            correctRtfHeader = this.Rtf.Substring(0, this.Rtf.IndexOf('{', 2)) + " ";
            // this returns something like '{\rtf1\ansi\ansicpg1251\deff0\deflang1049 '
        ...
        public void InsertLink(string text, string hyperlink, int position)
        {
            ...
            this.SelectionStart = position;
            this.SelectedRtf = correctRtfHeader + text + @"\v #" + hyperlink + @"\v0}";
            //this.SelectedRtf = correctRtfHeader + @" \v #" + hyperlink + @"\v0}";
