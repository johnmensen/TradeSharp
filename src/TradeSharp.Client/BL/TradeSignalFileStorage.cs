...
namespace TradeSharp.Client.BL
{
    ...
    //    /// </summary>        
    //    public DateTime? FindTradeSignal(int category, string ticker, string timeframeStr)
    //    {
    ...
    //            return TradeSignalXml.GetSignalUpdateParamsFromFile(fileName, TradeSignalXml.DefaultEncoding);
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //                {
    //                    // загрузить из файла
    //                    var updateDate = TradeSignalXml.GetSignalUpdateParamsFromFile(filePath, TradeSignalXml.DefaultEncoding);
    //                    if (updateDate.HasValue)
    //                    {
    //                        update.TimeUpdated = updateDate.Value;
    //                        updates.Add(update);
    //                    }
    //                }
    //                catch (Exception ex)
