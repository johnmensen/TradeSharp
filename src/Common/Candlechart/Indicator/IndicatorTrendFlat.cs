...
{
    [LocalizedDisplayName("TitleTrendAndFlat")]
    [LocalizedCategory("TitleTrending")]
    [TypeConverter(typeof(PropertySorter))]
    public class IndicatorTrendFlat : BaseChartIndicator, IChartIndicator
    {
        #region Основные / наследуемые настройки

        [Browsable(false)]
        public override string Name { get { return "Тренд/флэт"; } }
        ...
        [LocalizedDisplayName("TitleSlowMAPeriodShort")]
        ...
        [LocalizedDisplayName("TitleFastMAPeriodShort")]
        ...
        public IndicatorTrendFlat()
        {            
        }

        public override BaseChartIndicator Copy()
        {
            var indi = new IndicatorTrendFlat();
            Copy(indi);
            return indi;
        }
